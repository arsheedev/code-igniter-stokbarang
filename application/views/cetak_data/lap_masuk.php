...
$pdf->Cell(3.5, 0.7, 'Nama Barang', 1, 0, 'C');
...
foreach ($stock as $row) {
    $pdf->Cell(0.6, 0.7, $no , 1, 0, 'C');
	$pdf->Cell(3.5, 0.7, $row->nama_barang,1, 0, 'L');
