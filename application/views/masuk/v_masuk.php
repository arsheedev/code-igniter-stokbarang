...
.pagination {float: right;}
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        	<div class="col-md-12">
        		...
        		<a href="<?php echo base_url('masuk/cetak_masuk'); ?>" data-toggle="tooltip" title="Print"><i class="fa fa-print fa-2x" style="margin-bottom: 10px;padding: 0 0 0 5px;color:#5aab26;"></i></a>
            <a href="<?php echo base_url('masuk/excel_masuk'); ?>" data-toggle="tooltip" title="Excel"><i class="fa fa-file-excel-o fa-2x" style="margin-bottom: 10px;padding: 0 0 0 5px;color:#5aab26;"></i></a>

                <form class="form-inline" method="post" action="<?php echo base_url('masuk/hasil_cari_masuk'); ?>" style="margin-bottom: -6px;">
