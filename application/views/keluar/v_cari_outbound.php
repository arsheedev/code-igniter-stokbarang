<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <div>
          		...
          		<a href="<?php echo base_url('keluar/filter_cetak_keluar') . '/' . $temp_dari . '/' . $temp_sampai; ?>" data-toggle="tooltip" title="Print"><i class="fa fa-print fa-2x" style="margin-bottom: 10px;padding: 0 0 0 5px;color:#5aab26;"></i></a>
          		<a href="<?php echo base_url('keluar/filter_excel_keluar') . '/' . $temp_dari . '/' . $temp_sampai; ?>" data-toggle="tooltip" title="Excel"><i class="fa fa-file-excel-o fa-2x" style="margin-bottom: 10px;padding: 0 0 0 5px;color:#5aab26;"></i></a>
