        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        	<div class="col-md-12">
        		<h3 class="page-header" style="margin-top: 15px;margin:10px;">Add Outbound<small></small></h3>
        		<div class="col-sm-6">
              <form id="integerForm" class="form" method="POST" action="<?php echo base_url('keluar/history_output'); ?>">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="kategori" class="form-control form-control-sm" id="kategori" readonly placeholder="Kategori">
                  </div>
                </div>
                <div class="form-group row">
